#
#  Be sure to run `pod spec lint LNPopupController.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
  LNPopupController is a framework for presenting view controllers as popups of other view controllers.
                   DESC
  ...
  # Or just: s.author    = "Michal Thompson"
  # s.authors            = { "Michal Thompson" => "michal@evenly.io" }
  # s.social_media_url   = "http://twitter.com/Michal Thompson"
